...
public class SvaadAdapter extends ArrayAdapter<FeedDetailDto> {
	...
	public SvaadAdapter(Context context, int gridviewId, ListView grid,
			List<FeedDetailDto> feedList) {
	...
	public View getView(int arg0, View view, ViewGroup group) {
		...
		if (view == null) {
			...
			holder.tvAteitCount = (TextView) view
					.findViewById(R.id.tvAteitCount);
