...
public class CamPhotoAddDishUploadFileAsyncTask extends
	...
	private int action;
	String resBranchId,resPageBranchId,dishname;
	Boolean nonveg;

	public CamPhotoAddDishUploadFileAsyncTask(Context context, String mediaPath,
			String branchDishid, String commentText, List<String> userTags,
			String userId, int height, int width, int action,
			String resBranchId,String resPageBranchId,String dishname,Boolean nonveg) {
		...
		this.userId = userId;
		this.resPageBranchId=resPageBranchId;
		this.resBranchId=resBranchId;
...
//					if(resBranchId!=null && dishname!=null&& !dishname.equalsIgnoreCase("")&&!resBranchId.equalsIgnoreCase(""))
//					{
//						response = Utils.makePostRequest(Constants.CAM_DISH_ATE_IT,
//								requestJson);
//					}
//					else if(resPageBranchId!=null && dishname!=null&& !dishname.equalsIgnoreCase("")&&!resPageBranchId.equalsIgnoreCase(""))
//					{
//						response = Utils.makePostRequest(Constants.CAM_DISH_ATE_IT,
//								requestJson);
//					}
...
//					}
	...
	private CamPhotoUploadPhotoRequestDto getPhotoJson(String picturename,
		...
		camPhotoUploadPhotoRequestDto.setNonVeg(nonveg);
		if(pictureurl!=null)
	...
	protected void onPostExecute(CamPhotoResponseDto result) {
		...
		if (result != null) {
			...
			AddDishActivity addActivity=new AddDishActivity();
			if (addActivity.mactivity != null) {
				addActivity.mactivity.finish();
			}
