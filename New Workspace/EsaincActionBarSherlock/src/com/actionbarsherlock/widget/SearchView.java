...
public class SearchView extends LinearLayout implements CollapsibleActionView {
	...
	private SearchViewChangeMode changeModeListener;
	...
	public interface SearchViewChangeMode {
		public void onSearchViewCollapsed();
	}
	
	public void setOnSearchViewChangeMode(SearchViewChangeMode listener)
	{
		this.changeModeListener = listener;
	}
	...
	public SearchView(Context context, AttributeSet attrs) {
		...
		a = context.obtainStyledAttributes(attrs, R.styleable.SherlockView, 0,
				0);
		focusable = a.getBoolean(R.styleable.SherlockView_android_focusable,
				focusable);
		a.recycle();
	...
	public void onActionViewCollapsed() {
		...
		if(changeModeListener != null)
			changeModeListener.onSearchViewCollapsed();
	}
